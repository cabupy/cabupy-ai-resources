...
- Workflow `Catalog Consistency` para validar automaticamente coherencia entre catalogos, matriz y contratos.
...
- Actualizacion de `README.md`, `docs/README.md`, `CONTRIBUTING.md` y `RELEASE.md` para reflejar el estado actual del proyecto y los controles de calidad activos.
...
[Unreleased]: https://github.com/cabupy/cabupy-ai-resources/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/cabupy/cabupy-ai-resources/releases/tag/v0.2.0
